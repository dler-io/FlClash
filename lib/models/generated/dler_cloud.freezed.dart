...
mixin _$DlerCloudManagedData {
 ...
 String get name; String get smart; String get vmess; String? get ss2022;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DlerCloudManagedData&&(identical(other.name, name) || other.name == name)&&(identical(other.smart, smart) || other.smart == smart)&&(identical(other.vmess, vmess) || other.vmess == vmess)&&(identical(other.ss2022, ss2022) || other.ss2022 == ss2022));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,smart,vmess,ss2022);

@override
String toString() {
  return 'DlerCloudManagedData(name: $name, smart: $smart, vmess: $vmess, ss2022: $ss2022)';
}
...
@useResult
$Res call({
 String name, String smart, String vmess, String? ss2022
});
...
/// Create a copy of DlerCloudManagedData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? smart = null,Object? vmess = null,Object? ss2022 = freezed,}) {
  return _then(_self.copyWith(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,smart: null == smart ? _self.smart : smart // ignore: cast_nullable_to_non_nullable
as String,vmess: null == vmess ? _self.vmess : vmess // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String smart,  String vmess,  String? ss2022)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DlerCloudManagedData() when $default != null:
return $default(_that.name,_that.smart,_that.vmess,_that.ss2022);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String smart,  String vmess,  String? ss2022)  $default,) {final _that = this;
switch (_that) {
case _DlerCloudManagedData():
return $default(_that.name,_that.smart,_that.vmess,_that.ss2022);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String smart,  String vmess,  String? ss2022)?  $default,) {final _that = this;
switch (_that) {
case _DlerCloudManagedData() when $default != null:
return $default(_that.name,_that.smart,_that.vmess,_that.ss2022);case _:
  return null;
...
class _DlerCloudManagedData implements DlerCloudManagedData {
  const _DlerCloudManagedData({required this.name, required this.smart, required this.vmess, this.ss2022});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DlerCloudManagedData&&(identical(other.name, name) || other.name == name)&&(identical(other.smart, smart) || other.smart == smart)&&(identical(other.vmess, vmess) || other.vmess == vmess)&&(identical(other.ss2022, ss2022) || other.ss2022 == ss2022));
}
...
/// Create a copy of DlerCloudManagedData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? smart = null,Object? vmess = null,Object? ss2022 = freezed,}) {
